 ...
 * 
 * @version 1.0.0
 * @author Houssam Eddine Hamouich
 * @license MIT
 */
...
(function (root, factory) {
    ...
    function createRangeSlider(container, config) {
        ...
        <div class="range-slider-inputs">
            <input type="hidden" name="${config.minName}">
            <input type="hidden" name="${config.maxName}">
        </div>
    `;
        ...
        const inputMin = sliderElement.querySelector(`input[name="${config.minName}"]`);
        const inputMax = sliderElement.querySelector(`input[name="${config.maxName}"]`);
    ...
    function autoInitializeSliders() {
        ...
        elements.forEach(element => {
            ...
            const config = {
                ...
                minName: element.dataset.minName || 'min-value',
                maxName: element.dataset.maxName || 'max-value',
            };
